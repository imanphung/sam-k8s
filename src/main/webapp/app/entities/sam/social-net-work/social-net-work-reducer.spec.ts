...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOCIALNETWORK_LIST actions', async () => {
    ...
    it('dispatches FETCH_SOCIALNETWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SOCIALNETWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SOCIALNETWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SOCIALNETWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SOCIALNETWORK actions', async () => {
      const expectedActions = [
        {
