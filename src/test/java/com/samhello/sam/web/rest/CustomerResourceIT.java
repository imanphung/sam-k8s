...
import com.samhello.sam.domain.Customer;
import com.samhello.sam.domain.enumeration.Gender;
import com.samhello.sam.domain.enumeration.TypeOfAccount;
import com.samhello.sam.repository.CustomerRepository;
...
class CustomerResourceIT {
    ...
    private static final TypeOfAccount DEFAULT_TYPE_OF = TypeOfAccount.TEACHER;
    private static final TypeOfAccount UPDATED_TYPE_OF = TypeOfAccount.STUDENT;
    ...
    void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getTypeOf()).isEqualTo(DEFAULT_TYPE_OF);
    ...
    @Test
    @Transactional
    void checkTypeOfIsRequired() throws Exception {
        int databaseSizeBeforeTest = customerRepository.findAll().size();
        // set the field null
        customer.setTypeOf(null);
    ...
    void getAllCustomers() throws Exception {
        ...
        restCustomerMockMvc
            ...
            .andExpect(jsonPath("$.[*].typeOf").value(hasItem(DEFAULT_TYPE_OF.toString())))
    ...
    void getCustomer() throws Exception {
        ...
        restCustomerMockMvc
            ...
            .andExpect(jsonPath("$.typeOf").value(DEFAULT_TYPE_OF.toString()))
    ...
    void putNewCustomer() throws Exception {
        ...
        assertThat(testCustomer.getTypeOf()).isEqualTo(UPDATED_TYPE_OF);
