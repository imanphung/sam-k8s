...
class RoomResourceIT {
    ...
    private static final Long DEFAULT_MEETING_ID = 1L;
    private static final Long UPDATED_MEETING_ID = 2L;
    ...
    private static final RoomStatus DEFAULT_STATUS = RoomStatus.CREATED;
    private static final RoomStatus UPDATED_STATUS = RoomStatus.WAITING;
    ...
    void createRoom() throws Exception {
        ...
        assertThat(testRoom.getMeetingId()).isEqualTo(DEFAULT_MEETING_ID);
        assertThat(testRoom.getCreatedBy()).isEqualTo(DEFAULT_CREATED_BY);
        assertThat(testRoom.getLessonId()).isEqualTo(DEFAULT_LESSON_ID);
        assertThat(testRoom.getStartTime()).isEqualTo(DEFAULT_START_TIME);
        assertThat(testRoom.getEndTime()).isEqualTo(DEFAULT_END_TIME);
    ...
    @Test
    @Transactional
    void checkMeetingIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = roomRepository.findAll().size();
        // set the field null
        room.setMeetingId(null);
    ...
    void getAllRooms() throws Exception {
        ...
        restRoomMockMvc
            ...
            .andExpect(jsonPath("$.[*].meetingId").value(hasItem(DEFAULT_MEETING_ID.intValue())))
    ...
    void getRoom() throws Exception {
        ...
        restRoomMockMvc
            ...
            .andExpect(jsonPath("$.meetingId").value(DEFAULT_MEETING_ID.intValue()))
    ...
    void putNewRoom() throws Exception {
        ...
        Room testRoom = roomList.get(roomList.size() - 1);
        assertThat(testRoom.getMeetingId()).isEqualTo(UPDATED_MEETING_ID);
        assertThat(testRoom.getCreatedBy()).isEqualTo(UPDATED_CREATED_BY);
        assertThat(testRoom.getLessonId()).isEqualTo(UPDATED_LESSON_ID);
        assertThat(testRoom.getStartTime()).isEqualTo(UPDATED_START_TIME);
        assertThat(testRoom.getEndTime()).isEqualTo(UPDATED_END_TIME);
    ...
    void partialUpdateRoomWithPatch() throws Exception {
        ...
        partialUpdatedRoom.createdBy(UPDATED_CREATED_BY).lessonId(UPDATED_LESSON_ID).startTime(UPDATED_START_TIME).status(UPDATED_STATUS);
